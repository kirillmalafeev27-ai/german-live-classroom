...
// src/level-rules.js
var DEFAULT_LEVEL = "A0";
var LEVEL_SENTENCE_RULES = Object.freeze({
...
function getLevelSentenceRule(level) {
  return LEVEL_SENTENCE_RULES[String(level || "").toUpperCase()] || LEVEL_SENTENCE_RULES[DEFAULT_LEVEL];
}
function getLevelMaxWords(level) {
  return getLevelSentenceRule(level).maxWords;
}
function getEffectiveSentenceRule(level, configuredMaxWords) {
  const base = getLevelSentenceRule(level);
  const parsedMax = Number(configuredMaxWords);
  const maxWords = Number.isFinite(parsedMax) && parsedMax >= 2 ? Math.min(40, Math.round(parsedMax)) : base.maxWords;
  return {
...
function renderLevelWordLimitHint() {
  ...
  els.profileWordLimitHint.textContent = selected.maxWords === recommended.maxWords ? `${level}: ${recommended.minWords}\u2013${recommended.maxWords} \u0441\u043B\u043E\u0432` : `${level}: \u0440\u0435\u043A\u043E\u043C\u0435\u043D\u0434\u0443\u0435\u0442\u0441\u044F ${recommended.minWords}\u2013${recommended.maxWords}, \u0432\u044B\u0431\u0440\u0430\u043D \u043C\u0430\u043A\u0441\u0438\u043C\u0443\u043C ${selected.maxWords}`;
}
function renderRequiredWordsHint() {
  ...
  els.requiredWordsHint.textContent = requiredWords.length ? `\u0414\u043E\u0431\u0430\u0432\u043B\u0435\u043D\u043E: ${requiredWords.length}; \u043C\u0438\u043D\u0438\u043C\u0443\u043C ${requiredCount} \u0441\u043B\u043E\u0432. \u0414\u043B\u044F ${level}: ${rule.minWords}\u2013${rule.maxWords} \u0441\u043B\u043E\u0432.` : `\u0412\u0432\u0435\u0434\u0438\u0442\u0435 \u0441\u043B\u043E\u0432\u0430 \u0438\u043B\u0438 \u0444\u0440\u0430\u0437\u044B \u0447\u0435\u0440\u0435\u0437 \u0437\u0430\u043F\u044F\u0442\u0443\u044E. \u0414\u043B\u044F ${level} \u043F\u0440\u0435\u0434\u043B\u043E\u0436\u0435\u043D\u0438\u0435 \u0431\u0443\u0434\u0435\u0442 \u0434\u043B\u0438\u043D\u043E\u0439 ${rule.minWords}\u2013${rule.maxWords} \u0441\u043B\u043E\u0432.`;
}
  ...
  try {
    ...
    state.teacherCapture = await startVoiceCapture({
      ...
      onState: (phase) => {
        ...
        else if (phase === "speaking") els.teacherMicPartial.textContent = "\u{1F399} \u0421\u043B\u044B\u0448\u0443 \u0432\u0430\u0441, \u0433\u043E\u0432\u043E\u0440\u0438\u0442\u0435\u2026";
        else if (phase === "empty") els.teacherMicPartial.textContent = "\u{1F507} \u0417\u0432\u0443\u043A \u043D\u0435 \u043F\u043E\u0439\u043C\u0430\u043D \u2014 \u0433\u043E\u0432\u043E\u0440\u0438\u0442\u0435 \u0431\u043B\u0438\u0436\u0435 \u043A \u043C\u0438\u043A\u0440\u043E\u0444\u043E\u043D\u0443.";
...
async function handleTeacherSegment(blob) {
  try {
    ...
    if (!text) {
      els.teacherMicPartial.textContent = "\u{1F507} \u041D\u0435 \u0440\u0430\u0441\u0441\u043B\u044B\u0448\u0430\u043B \u0440\u0430\u0437\u0431\u043E\u0440\u0447\u0438\u0432\u0443\u044E \u0440\u0435\u0447\u044C (\u0442\u0438\u0448\u0438\u043D\u0430 \u0438\u043B\u0438 \u0448\u0443\u043C). \u041F\u043E\u0432\u0442\u043E\u0440\u0438\u0442\u0435.";
      return;
    }
    state.teacherCommandText = text;
    els.teacherCommandInput.value = text;
    els.teacherMicPartial.textContent = `\u2705 \u0423\u0441\u043B\u044B\u0448\u0430\u043B: \xAB${text}\xBB \u2014 \u043F\u0440\u043E\u0432\u0435\u0440\u044C\u0442\u0435 \u0438 \u043D\u0430\u0436\u043C\u0438\u0442\u0435 \xAB\u0412\u044B\u0434\u0430\u0442\u044C \u0443\u0447\u0435\u043D\u0438\u043A\u0443\xBB.`;
...
async function sendTeacherVoiceCommand() {
  ...
  try {
    ...
    announceSpeechResult(result, `\u041A\u043E\u043C\u0430\u043D\u0434\u0430 \u043F\u0440\u043E\u0437\u0432\u0443\u0447\u0430\u043B\u0430 \u0433\u043E\u043B\u043E\u0441\u043E\u043C \xAB${result.voiceLabel || state.activeVoice}\xBB`, "\u041A\u043E\u043C\u0430\u043D\u0434\u0430 \u043E\u0442\u043F\u0440\u0430\u0432\u043B\u0435\u043D\u0430 \u0433\u043E\u043B\u043E\u0441\u043E\u043C \u0431\u0440\u0430\u0443\u0437\u0435\u0440\u0430");
  } catch (error) {
    toast(error.message, "error");
  } finally {
...
async function generate(action = "AUTO") {
  ...
  if (countWords(requiredWords.join(" ")) > rule.maxWords) {
    toast(`\u0421\u0430\u043C\u0438 \u0437\u0430\u0434\u0430\u043D\u043D\u044B\u0435 \u0441\u043B\u043E\u0432\u0430 \u0434\u043B\u0438\u043D\u043D\u0435\u0435 \u043B\u0438\u043C\u0438\u0442\u0430 ${level} (${rule.maxWords}). \u0423\u0431\u0435\u0440\u0438\u0442\u0435 \u0447\u0430\u0441\u0442\u044C \u0441\u043B\u043E\u0432 \u0438\u043B\u0438 \u0432\u044B\u0431\u0435\u0440\u0438\u0442\u0435 \u0434\u0440\u0443\u0433\u043E\u0439 \u0443\u0440\u043E\u0432\u0435\u043D\u044C.`, "error", 6e3);
    return;
  }
  try {
...
function renderCandidate() {
  ...
  els.candidateMeta.innerHTML = [
    makePill(
      "\u0421\u043B\u043E\u0432",
      c.sentence_min_words && c.sentence_max_words ? `${c.word_count} / ${c.sentence_min_words}\u2013${c.sentence_max_words}` : c.word_count ?? String(c.main).trim().split(/\s+/).length,
...
async function speak(playbackRate, voice = state.activeVoice) {
  ...
  try {
    ...
    announceSpeechResult(result, `\u041E\u0442\u043F\u0440\u0430\u0432\u043B\u0435\u043D\u043E \u0443\u0447\u0435\u043D\u0438\u043A\u0443 \u0433\u043E\u043B\u043E\u0441\u043E\u043C \xAB${result.voiceLabel || voice}\xBB`, "\u041E\u0442\u043F\u0440\u0430\u0432\u043B\u0435\u043D\u043E \u0447\u0435\u0440\u0435\u0437 \u0433\u043E\u043B\u043E\u0441 \u0431\u0440\u0430\u0443\u0437\u0435\u0440\u0430");
  } catch (error) {
    toast(error.message, "error");
  } finally {
    setBusy(button, false);
...
function announceSpeechResult(result, okMessage, fallbackMessage) {
  ...
  if (result.ttsError) {
    toast(`${fallbackMessage}: ElevenLabs \u043D\u0435\u0434\u043E\u0441\u0442\u0443\u043F\u0435\u043D \u2014 ${result.ttsError}`, "warn", 7e3);
    return;
  }
